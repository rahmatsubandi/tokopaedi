    ...
    <section class="store-heading">
      <div class="container">
        <div class="row">
          <div class="col-lg-8">
            <h1>Sofo Empuk</h1>
            <div class="owner">By Rahmat Subandi</div>
        ...
        <div class="row">
          <div class="col-12 col-lg-8">
            <ul class="list-unstyled">
              <li class="media">
                <img src="/images/icons-testimonial-1.png" alt="testimonial-1" class="mr-3 rounded-circle" />
                <div class="media-body">
                  <h5 class="mt-2 mb-1">Mia Khalifa</h5>
              ...
              <li class="media">
                <img src="/images/icons-testimonial-2.png" alt="testimonial-2" class="mr-3 rounded-circle" />
                <div class="media-body">
              ...
              <li class="media">
                <img src="/images/icons-testimonial-3.png" alt="testimonial-3" class="mr-3 rounded-circle" />
                <div class="media-body">
                  <h5 class="mt-2 mb-1">Megu Fujiura</h5>
